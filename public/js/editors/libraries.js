var libraries = [
  ...
  {
    'url': 'http://code.jquery.com/jquery-3.1.0.js',
    'label': 'jQuery 3.1.0',
    'group': 'jQuery'
  },
  {
    'url': 'http://code.jquery.com/jquery-3.0.0.js',
    'label': 'jQuery 3.0.0',
    'group': 'jQuery'
  },
  {
  ...
  {
    'url': 'http://code.jquery.com/jquery-1.6.4.js',
    'label': 'jQuery 1.6.4',
    'group': 'jQuery'
  },
  {
  ...
  {
    'url': [
      'http://code.jquery.com/mobile/1.4.2/jquery.mobile-1.4.2.css',
      'http://code.jquery.com/jquery-1.11.3.js',
  ...
  {
    'url': [
      'http://code.jquery.com/mobile/1.3.2/jquery.mobile-1.3.2.css',
  ...
  {
    'url': [
      'http://code.jquery.com/mobile/1.2.1/jquery.mobile-1.2.1.css',
      'http://code.jquery.com/jquery-1.8.3.js',
      'http://code.jquery.com/mobile/1.2.1/jquery.mobile-1.2.1.js'
    ],
  ...
  {
    'url': [
      'http://code.jquery.com/mobile/1.1.2/jquery.mobile-1.1.2.css',
      'http://code.jquery.com/jquery-1.6.4.js',
      'http://code.jquery.com/mobile/1.1.2/jquery.mobile-1.1.2.js'
    ],
  ...
  {
    'url': [
      'http://da7xgjtj801h2.cloudfront.net/2015.2.624/styles/kendo.common.min.css',
      'http://da7xgjtj801h2.cloudfront.net/2015.2.624/styles/kendo.silver.min.css',
      'http://code.jquery.com/jquery-2.1.4.min.js',
      'http://da7xgjtj801h2.cloudfront.net/2015.2.624/js/kendo.ui.core.min.js'
    ],
  ...
  {
    'url': [
      'http://da7xgjtj801h2.cloudfront.net/2014.3.1411/styles/kendo.common.min.css',
      'http://da7xgjtj801h2.cloudfront.net/2014.3.1411/styles/kendo.default.min.css',
      'http://code.jquery.com/jquery-1.9.1.min.js',
      'http://da7xgjtj801h2.cloudfront.net/2014.3.1411/js/kendo.ui.core.min.js'
    ],
  ...
  {
    'url' : [
    'http://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.14/require.js',
  ],
    'label': 'RequireJS',
    'group': 'AMD'
  },
  ...
  {
    'url':'http://ajax.googleapis.com/ajax/libs/angularjs/1.4.0/angular.min.js',
    'label': 'Angular 1.4.0 Stable',
    'group': 'Angular'
  },
  {
    'url': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.4.0/angular.js',
    'label': 'Angular 1.4.0 Stable Uncompressed',
    'group': 'Angular'
  },
  {
    'url':'http://ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js',
    'label': 'Angular 1.3.15 Stable',
    'group': 'Angular'
  },
  {
    'url': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.js',
    'label': 'Angular 1.3.15 Stable Uncompressed',
    'group': 'Angular'
  },
  {
    'url': 'http://ajax.googleapis.com/ajax/libs/angularjs/1.2.26/angular.min.js',
    'label': 'Angular 1.2.26 Legacy',
    'group': 'Angular'
  },
  {
    'url':'http://rawgit.com/angular/bower-angular/master/angular.min.js',
    'label': 'Angular Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular/master/angular.js',
    'label': 'Angular Latest Uncompressed',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-animate/master/angular-animate.min.js',
    'label': 'Angular Animate Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-aria/master/angular-aria.min.js',
    'label': 'Angular Aria Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-messages/master/angular-messages.min.js',
    'label': 'Angular Messages Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-resource/master/angular-resource.min.js',
    'label': 'Angular Resource Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-route/master/angular-route.min.js',
    'label': 'Angular Route Latest',
    'group': 'Angular'
  },
  {
    'url': 'http://rawgit.com/angular/bower-angular-sanitize/master/angular-sanitize.min.js',
    'label': 'Angular Sanitize Latest',
    'group': 'Angular'
  },
  {
    'url': ['http://fb.me/react-15.1.0.js', 'http://fb.me/react-dom-15.1.0.js'],
    'label': 'React + React DOM 15.1.0',
    'group': 'React'
  },
  {
    'url': ['http://fb.me/react-with-addons-15.1.0.js', 'http://fb.me/react-dom-15.1.0.js'],
    'label': 'React with Add-Ons + React DOM 15.1.0',
    'group': 'React'
  },
  {
    'url': ['http://fb.me/react-0.14.7.js', 'http://fb.me/react-dom-0.14.7.js'],
    'label': 'React + React DOM 0.14.7',
    'group': 'React'
  },
  {
    'url': ['http://fb.me/react-with-addons-0.14.7.js', 'http://fb.me/react-dom-0.14.7.js'],
    'label': 'React with Add-Ons + React DOM 0.14.7',
    'group': 'React'
  },
  {
    'url': 'http://fb.me/react-0.13.3.js',
    'label': 'React 0.13.3',
    'group': 'React'
  },
  {
    'url': 'http://fb.me/react-with-addons-0.13.3.js',
    'label': 'React with Add-Ons 0.13.3',
    'group': 'React'
  },
  {
    'url': 'http://cdn.rawgit.com/zloirock/core-js/master/client/shim.min.js',
    'label': 'core-js',
    'group': 'shims'
  },
  {
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/blissfuljs/1.0.2/bliss.min.js',
    'label': 'Bliss 1.0.2',
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/vue/1.0.16/vue.js',
    'label': 'Vue.js 1.0.16',
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/vue/2.0.3/vue.js',
    'label': 'Vue.js 2.0.3',
  },
  {
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/bluebird/1.2.2/bluebird.js',
    'label': 'Bluebird 1.2.2',
    'group': 'Promises'
  },
  {
    'url': 'http://www.promisejs.org/polyfills/promise-4.0.0.js',
    'label': 'Promise 4.0.0',
    'group': 'Promises'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/q.js/1.0.1/q.js',
    'label': 'Q 1.0.1',
    'group': 'Promises'
  },
  {
  ...
  {
    'url': [
      'http://rawgithub.com/ai/autoprefixer-rails/master/vendor/autoprefixer.js'
    ],
    'label': 'Autoprefixer',
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/coffee-script/1.9.2/coffee-script.min.js',
    'label': 'CoffeeScript'
  },
  {
    'url': [
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/normalize/3.0.2/normalize.min.css',
  ...
  {
    'url': [
      'http://cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/css/normalize.min.css',
      'http://cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/css/foundation.min.css',
      'http://cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/vendor/modernizr.js',
      'http://cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/vendor/jquery.js',
      'http://cdnjs.cloudflare.com/ajax/libs/foundation/5.5.2/js/foundation.min.js'
    ],
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/knockout/3.3.0/knockout-min.js',
  ...
  {
    'url': 'http://cdn.jsdelivr.net/lodash/4/lodash.min.js',
    'label': 'lodash 4.x',
    'group': 'Lodash'
  },
  {
    'url': 'http://cdn.jsdelivr.net/g/lodash@4(lodash.min.js+lodash.fp.min.js)',
    'label': 'lodash fp 4.x',
    'group': 'Lodash'
  },
  {
    'url': 'http://cdn.jsdelivr.net/lodash/3/lodash.min.js',
    'label': 'lodash 3.x',
    'group': 'Lodash'
  },
  {
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/d3/4.2.3/d3.min.js',
    'label': 'D3 4.2.3',
    'group': 'D3'
  },
  {
  ...
  {
    'url':[
      'http://cdnjs.cloudflare.com/ajax/libs/three.js/r82/three.min.js'
    ],
    'label': 'Three.js r82'
  },
  {
  ...
  {
    'url': [
      'http://cdnjs.cloudflare.com/ajax/libs/polymer/0.3.3/platform.js',
      'http://cdnjs.cloudflare.com/ajax/libs/polymer/0.3.3/polymer.js'
    ],
    'label': 'Polymer 0.3.3'
  },
  {
    'url':[
      'http://code.getmdl.io/1.2.1/material.indigo-pink.min.css',
      'http://code.getmdl.io/1.2.1/material.min.js',
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/paper.js/0.9.12/paper.js',
    'label': 'Paper.js 0.9.12'
  },
  {
    'url': {
      'url': 'http://openui5.hana.ondemand.com/resources/sap-ui-core.js',
      'id': 'sap-ui-bootstrap',
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/phaser/2.0.5/phaser.min.js',
    'label': 'Phaser 2.0.5'
  },
  {
    'url': [
  ...
  {
    'url': [
      'http://aui-cdn.atlassian.com/aui-adg/5.7.0/js/aui.js',
      'http://aui-cdn.atlassian.com/aui-adg/5.7.0/css/aui.css',
      'http://aui-cdn.atlassian.com/aui-adg/5.7.0/js/aui-experimental.js',
      'http://aui-cdn.atlassian.com/aui-adg/5.7.0/css/aui-experimental.css'
    ],
    'label': 'AUI (Atlassian UI) 5.7.0'
  },
  {
    'url': 'http://cdn.firebase.com/js/client/2.0.2/firebase.js',
    'label': 'Firebase 2.0.2'
  },
  {
    'url': [
      'http://code.ionicframework.com/1.0.0-beta.13/js/ionic.bundle.min.js',
      'http://code.ionicframework.com/1.0.0-beta.13/css/ionic.min.css'
    ],
  ...
  {
    'url': 'http://cdn.jsdelivr.net/riot/2.6/riot+compiler.min.js',
    'label': 'Riot + Compiler (latest 2.6.x)'
  },
  {
    'url': [
      'http://unpkg.com/blaze/dist/blaze.min.css',
      'http://unpkg.com/blaze/dist/blaze.colors.min.css'
    ],
    'label': 'Blaze CSS (latest)'
  },
  {
    'url': 'http://unpkg.com/@reactivex/rxjs@5.0.3/dist/global/Rx.js',
    'label': 'RxJS 5.0.3',
    'group': 'RxJS'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.all.js',
    'label': 'rx.all 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.all.compat.js',
    'label': 'rx.all.compat 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/rxjs/4.0.6/rx.testing.js',
    'label': 'rx.testing 4.0.6',
    'group': 'RxJS'
  },
  {
    'url': 'http://unpkg.com/rx-dom@7.0.3/dist/rx.dom.js',
  ...
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/immutable/3.7.3/immutable.min.js',
    'label': 'Immutable 3.7.3',
    'group': 'Data structures'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/mori/0.3.2/mori.js',
    'label': 'mori 0.3.2',
    'group': 'Data structures'
  },
  {
    'url': 'http://cdnjs.cloudflare.com/ajax/libs/ramda/0.22.1/ramda.min.js',
    'label': 'Ramda 0.22.1'
  },
  {
    'url': [
      'http://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.2/semantic.min.css',
      'http://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.2/semantic.min.js'
    ],
    'label': 'Semantic UI 2.2.2'
  },
  {
    'url': 'http://cdn.jsdelivr.net/pouchdb/latest/pouchdb.min.js',
    'label': 'PouchDB (latest)',
    'group': 'PouchDB'
  },
  {
    'url': 'http://cdn.jsdelivr.net/momentjs/2.14.1/moment-with-locales.min.js',
    'label': 'Moment 2.14.1',
    'group': 'Moment.js'
  },
  {
    'url': [
      'http://cdn.jsdelivr.net/momentjs/2.14.1/moment-with-locales.min.js',
      'http://cdn.jsdelivr.net/momentjs/2.14.1/locales.min.js'
    ],
